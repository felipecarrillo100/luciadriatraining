...
import {LabelAnnotationController, POINT_CREATION_EVENT} from "./LabelAnnotationController.ts";
...
} from "./LabelAnnotationPainter.ts";
...
import {AnnotationSupport} from "../AnnotationSupport.ts";
