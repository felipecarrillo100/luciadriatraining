...
import {MeasurementAnnotationController} from './MeasurementAnnotationController.ts';
import {
  MeasurementAnnotationPainter,
  MeasurementAnnotationStyles,
  MeasurementFeature,
  MeasurementFeatureProperties
} from './MeasurementAnnotationPainter.ts';
...
import {Annotation, AnnotationSupport, AnnotationSupportCreateOptions} from "../AnnotationSupport.ts";
