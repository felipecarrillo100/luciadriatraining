...
export class CartesianRulerController extends Controller {
  ...
  override onGestureEvent(e: GestureEvent): HandleEventResult {
  ...
  override on(event: "Activated" | "Deactivated" | "Invalidated" | typeof CARTESIAN_MEASUREMENT_CHANGED_EVENT,
