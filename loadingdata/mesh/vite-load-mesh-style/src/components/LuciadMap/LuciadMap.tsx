    ...
    const toggleStyle = () => {
        if (nativeMap.current) {
            ...
            if (meshLayer instanceof TileSet3DLayer) {
                if (meshLayer.meshStyle.colorExpression === null) {
                    if (meshStyle.current) {
                        meshLayer.meshStyle.colorExpression = meshStyle.current.colorExpression;
                    }
                } else {
                    meshLayer.meshStyle.colorExpression = null;
                }
            }
        }
    }
