...
import {PanoIcon} from "../pano/PanoIcon";
...
export class PanoramaFeaturePainter extends FeaturePainter {
    ...
    override paintBody(geoCanvas: GeoCanvas, feature: Feature, shape: Shape, layer: Layer, map: RIAMap, paintState: PaintState): void {
    ...
    getPanoOrientation(feature: Feature): number {
        // @ts-ignore
      return typeof (feature.properties as unknown).orientation !== "undefined" ? feature.properties.orientation : 0;
    }
