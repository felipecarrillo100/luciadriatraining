...
} from '../firstperson/modularcontrollers/MouseButtonsController';
...
import { CameraOrbitRotateZoomPanController } from '@pages/map/luciad-map/controllers/camera-modes/CameraOrbitRotateZoomPanController';
...
export class CameraOrbitNavigationController extends MapAbstractController {
  public constructor(
    ...
    this.appendController(new CameraOrbitRotateZoomPanController({}, bounds));
