...
import { KeyNavigationSupport, NavigationKeysMode } from '../keyboard/KeyNavigationSupport';
...
export interface SceneNavigationControllerOptions {
  /**
   * The default movement speed of this controller when pressing keyboard keys, in meters per seconds.
   * The default is 5m/s.
   */
  defaultSpeed?: number;

  /**
   * The multiplier applied to the default movement speed ({@link defaultSpeed} of this controller when shift is pressed in meters per seconds,
   * The default is 0.25.
   */
  slowerMultiplier?: number;

  /**
   * The multiplier applied to the default movement speed ({@link defaultSpeed} of this controller when space is pressed in meters per seconds,
   * The default is 3.
   */
