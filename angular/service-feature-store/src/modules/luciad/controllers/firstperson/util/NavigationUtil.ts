...
/**
 * Returns whether the given point is contained in the given bounds.
 * If the point and bounds object is not in the same reference, the point will be transformed to the reference of the bounds.
 */
