...
import { drawDistanceLabel } from './MeasurementUtil';
...
export class DistanceMeasurement extends Measurement<MeasurementSegment, DistanceMeasurementInfo> {
  constructor() {
    super(EAnnotationsTypes.Distance);
  }
  ...
  paintBody(geoCanvas: GeoCanvas, { mainLineStyles, pointStyles }: MeasurementPaintStyles): void {
