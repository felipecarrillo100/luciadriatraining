...
import { CameraOrbitNavigationController } from '@pages/map/luciad-map/controllers/camera-modes/CameraOrbitNavigationController';
import { ConfirmationDialogService } from '@shared/services/confirmation-dialog.service';

export class PanoramicOrbitController extends MapAbstractController {
  constructor(
    ...
    const cameraOrbitNavigationController = new CameraOrbitNavigationController(
      {
        lockMouse: true,
    ...
    mainMapController.appendController(cameraOrbitNavigationController);
  }
}
