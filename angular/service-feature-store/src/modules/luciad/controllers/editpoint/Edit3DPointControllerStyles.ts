...
import { IconFactory } from '@pages/map/luciad-map/controllers/ruler3d/IconFactory';
...
const altitudeStyle: ShapeStyle = {
  stroke: { color: 'rgba(0,255,0,0.5)', width: 2 },
  zOrder: 2,
  occlusionMode: OcclusionMode.VISIBLE_ONLY,
};
...
export const Edit3DPointControllerStyles = {
  pathController: {
    altitudeStyle,
    altitudeFocusStyle,
    iconStyle,
