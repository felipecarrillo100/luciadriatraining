...
import { cross, scale } from '../../util/Vector3Util';
...
export class AltitudeHandleSupport {
  ...
  drawLabel(labelCanvas: LabelCanvas) {
    const html = `<div style="background-color: white; color: black; padding: 6px; border-radius: 6px">${this._heightDiff.toFixed(
      1,
    )}m</div>`;
