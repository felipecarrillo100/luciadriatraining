...
export class ControllerHandle {
  ...
  private _interactionFunction: ((...any: never) => Point) | ((...any: never) => number) | null;
   ...
   */
  get interactionFunction(): ((...any: never) => Point) | ((...any: never) => number) | null {
    return this._interactionFunction;
  }

  set interactionFunction(value: ((...any: never) => Point) | ((...any: never) => number) | null) {
  ...
  update(
    ...
    interactsWithMouseFunction: (viewPoint: Point) => boolean,
  ): void {
