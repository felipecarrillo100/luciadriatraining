...
class IconProviderClass {
  public icons: NonNullable<unknown>;

  constructor() {
    this.icons = {};
    this.registerIcon(IconProviderShapes.HEXAGON, 'Hexagon', IconImageFactory.hexagon, { width: 12, height: 12 });
    ...
    this.registerIcon(IconProviderShapes.TRIANGLE, 'Triangle', IconImageFactory.triangle, {
      width: 24,
      height: 24,
    });
    this.registerIcon(IconProviderShapes.STAR, 'Star', IconImageFactory.star, { width: 24, height: 24 });
    this.registerIcon(IconProviderShapes.NAVAID, 'Navaid', IconImageFactory.navaid, { width: 24, height: 24 });
    this.registerIcon(IconProviderShapes.RECTANGLE, 'Rectangle', IconImageFactory.rectangle, {
      width: 24,
      height: 24,
    });
    ...
    this.registerIcon(IconProviderShapes.GRADIENTCIRCLE, 'Gradient Circle', IconImageFactory.gradientCircle, {
      width: 20,
      height: 20,
    });
  }
