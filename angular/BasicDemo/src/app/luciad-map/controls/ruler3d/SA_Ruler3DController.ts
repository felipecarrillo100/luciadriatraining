...
export class SA_Ruler3DController<S extends MeasurementSegment = MeasurementSegment> extends Controller {
  ...
  private prevCursorValue: string = "default";
  ...
  constructor(measurement: Measurement<S>,
    ...
    super();
    this._eventedSupport = new EventedSupport([MEASUREMENT_FINISHED_EVENT, ENABLED_CHANGE_EVENT], true)
